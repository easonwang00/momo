...
function YourExpressButton({ navigation }) {
  const { user } = useUser();
  return (
    <TouchableOpacity
      style={{
      ...
      onPress={() => {
        navigation.push("UserExpressList", {
          userID: user.id,
      ...
      <View style={styles.container}>
        ...
        <View style={styles.inputContent}>
          ...
          <TouchableOpacity
            style={styles.addBtn}
            onPress={() => {
              navigationRef.current?.navigate("CreateFlow");
            }}
          >
        ...
        <YourExpressButton navigation={this.props.navigation} />
        {/* <ListView
          firstLoader
